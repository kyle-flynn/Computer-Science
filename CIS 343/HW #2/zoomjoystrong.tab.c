...
#line 38 "zoomjoystrong.y" /* yacc.c:1648  */
    ...
    if((yyvsp[-4].intValue) >= 0 && (yyvsp[-4].intValue) <= WIDTH &&  (yyvsp[-3].intValue) >= 0 && (yyvsp[-3].intValue) <= HEIGHT) {
      ...
      printf("Width must be between 0 and %d, and height must be between 0 and %d.", WIDTH, HEIGHT);
    }
}
...
#line 1278 "zoomjoystrong.tab.c" /* yacc.c:1648  */
    break;

  case 14:
#line 74 "zoomjoystrong.y" /* yacc.c:1648  */
    {
    if ((yyvsp[-3].intValue) >= 0 && (yyvsp[-3].intValue) <= 255 && (yyvsp[-2].intValue) >= 0 && (yyvsp[-2].intValue) <= 255 && (yyvsp[-1].intValue) >= 0 && (yyvsp[-1].intValue) <= 255) {
      ...
      printf("RGB Values must be betweem 0 and 255\n");
    }
}
