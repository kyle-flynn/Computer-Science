...
*/
SELECT DENSE_RANK(30000) WITHIN 
	GROUP (ORDER BY salary) "Dense Rank" 
	FROM employee;
-- 
...
*/
SELECT DENSE_RANK(31000) WITHIN 
	GROUP (ORDER BY salary) "Dense Rank" 
	FROM employee;
--
